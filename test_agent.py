...
USER_REQUEST = "Tạo một DB Subnet Group mới tên 'my-db-subnet-group' sử dụng 2 subnet bất kỳ trong VPC mặc định. Sau đó, khởi tạo một cơ sở dữ liệu MySQL tên 'production-db' với class 'db.t3.micro', dung lượng 20GB, username 'admin' và password 'SecurePass123!' sử dụng DB Subnet Group vừa tạo." #create a t3.micro ec2 instance in ap-southeast-1 with SSH access
